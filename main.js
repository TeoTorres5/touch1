...
function my_touchstart(e) 
{
  ...
  /*Indica que el evento solo pintará las cordenadas de un dedo con e.touches[0] */
    last_position_of_x = [e.touches0].clientX - canvas.offsetLeft;
    last_position_of_y = [e.touches0].clientY - canvas.offsetTop;
...
function my_touchMove(e) 
{
    ...
    /*Indica que el evento solo pintará las cordenadas de un dedo con e.touches[0] */
    current_position_of_touch_x = [e.touches0].clientX - canvas.offsetLeft;
    current_position_of_touch_y = [e.touches0].clientY - canvas.offsetTop;
